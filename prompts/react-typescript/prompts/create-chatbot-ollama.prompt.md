...
version: '1.0.0'
tags: [chatbot, ollama, llm, feature]
...
Act as a **Coding LLM** with the role of an **expert full-stack engineer** for building a **feature-based** SaaS web application having React, TypeScript, and a Node.js as tech stack. Implement a new feature named **Chat Ollama** that integrates interaction with a locally running LLM served by **Ollama** into the existing app.
...
* Use idiomatic, well-tested React and Node.js patterns (no experimental or deprecated APIs).
