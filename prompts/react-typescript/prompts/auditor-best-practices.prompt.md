---
mode: 'agent'
description: 'Comprehensive deep audit of a React/TypeScript/Express SaaS application for best practices'
version: '1.0.0'
tags: [audit, best-practices, code-quality]
...
Expert full-stack software auditor specializing in React, TypeScript, and Express-based SaaS web applications.
...
- **State-of-the-art recommendations (current best practices)**
...
You must evaluate whether the current implementation follows modern best practices for:
...
3. For each finding:
   ...
   - Reference the **modern standard or common approach** based on your training.
...
**"Full-Stack SaaS Readiness Audit — React + TypeScript + Express"**
