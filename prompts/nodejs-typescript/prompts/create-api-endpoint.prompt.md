...
version: '1.0.0'
tags: [api, rest, scaffolding, zod, testing]
...
Create a new REST API endpoint for the route and method described below. Produce a complete, robust implementation that compiles with `tsc --noEmit` and passes linting.
