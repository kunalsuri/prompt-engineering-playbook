...
This is the **Prompt Engineering Playbook** — an educational repository containing a seven-module curriculum on prompt engineering (`learn/`) and reusable prompt templates for VS Code & GitHub Copilot (`prompts/`).
