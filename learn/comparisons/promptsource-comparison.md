...
The `.prompt.md` files in this repository's [`prompts/`](../../prompts/README.md) directory are template-based prompts designed for VS Code Copilot. They follow the PromptSource philosophy of structured, reusable, versioned prompt artifacts:
