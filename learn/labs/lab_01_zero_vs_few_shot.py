...
from lab_utils import complete, ensure_sandbox_environment, get_client, print_comparison_table, print_header
...
def run_experiment() -> None:
    ...
    for variant_name, template in [("zero_shot", ZERO_SHOT_TEMPLATE), ("few_shot", FEW_SHOT_TEMPLATE)]:
        ...
        for review, expected in TEST_CASES:
            ...
            vote_counts = Counter(run_results)
            majority = sorted(vote_counts.items(), key=lambda item: (-item[1], item[0]))[0][0]
