...
|------|-------------|-----------------|
| [01 — Kitchen Sink](01-kitchen-sink/broken-prompt.md) | Overloaded, multi-goal prompt | Module 4 §4.5 |
| [02 — Stale Context](02-stale-context/broken-prompt.md) | Hallucination bait; missing grounding | Module 5 §5.1 |
| [03 — Injection Vulnerable](03-injection-vulnerable/broken-prompt.md) | Unguarded system prompt | Module 5 §5.2 |
| [04 — Ambiguous Format](04-ambiguous-format/broken-prompt.md) | No output schema specified | Module 3 §3.6 |
| [05 — Missing Constraints](05-missing-constraints/broken-prompt.md) | Absent role + constraints; vague task | Module 1 §1.3 + Module 2 §2.1 |
