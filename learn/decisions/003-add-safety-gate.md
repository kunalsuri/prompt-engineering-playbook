...
| Field | Value |
|---|---|
| Evidence type | Internal red-team and safety evaluation (project-specific) |
| Safety categories | Prompt injection, financial-advice leakage, policy-compliance flags |
| Measurement basis | Controlled attack suites + labeled safe/unsafe output sets |
| As-of date | 2026-02-15 |
| External reproducibility | Not yet published as open evaluation artifacts |

> **Interpretation rule:** Safety rates in this ADR are tied to one domain (financial summaries) and one test suite. Reproduce with your own threat model and adversarial corpus before relying on these thresholds.
